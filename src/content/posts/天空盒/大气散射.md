...
$\beta$ 与 $\lambda^4$ 乘反比，也能解释 白天天空为蓝色，夕阳为橙红色：蓝光被散射强（朝四面八方散射），红光直接穿透大气，因此白天天空进入眼睛的颜色大多是蓝色（也因为人类视网膜对蓝光的敏感度远高于紫光）。夕阳是因为穿过大气层的厚度变大，蓝紫光几乎全被散射，只有红光等长波长光能穿透过来<br>
$\rho_m(h)$ 马上说
...
$D \left(\overline{PA}\right)$   可以再优化  ：$D \left(\overline{CP}\right)$ 的路径各不相同，但是 $D \left(\overline{PA}\right)$ 的路径是有重叠的
