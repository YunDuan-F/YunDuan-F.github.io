...
import { CollapseComponent } from "./src/plugins/rehype-component-collapse.mjs";
...
export default defineConfig({
	site: "https://YunDuan-F.github.io",
	base: "/",
	...
	integrations: [
		...
		expressiveCode({
			...
			styleOverrides: {
				codeBackground: "var(--codeblock-content-bg)",
				borderRadius: "1rem",
				...
				frames: {
					editorBackground: "var(--codeblock-content-bg)",
					terminalBackground: "var(--codeblock-content-bg)",
					terminalTitlebarBackground: "var(--codeblock-header-bg)",
					editorTabBarBackground: "var(--codeblock-header-bg)",
					editorActiveTabBackground: "none",
					editorActiveTabIndicatorBottomColor: "var(--primary)",
					editorActiveTabIndicatorTopColor: "none",
					editorTabBarBorderBottomColor: "var(--codeblock-border)",
